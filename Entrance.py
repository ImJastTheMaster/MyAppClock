import Check_user, World_time, Registration, function_save, constants, \
    calendar, Player_music, Add_user, my_PushButton
import sys
...
class EntranceApp(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi('./Design/entranse_disain.ui', self)
...
if __name__ == '__main__':
    ...
    app.setWindowIcon(QIcon('./Arts/chasy.png.crdownload'))
    window = EntranceApp()
